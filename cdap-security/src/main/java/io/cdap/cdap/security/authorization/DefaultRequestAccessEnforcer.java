...
/**
 * An implementation of {@link RequestAccessEnforcer} that retrieves current principal
 * using {@link AuthenticationContext} and delegates to
 * {@link AccessEnforcer}
 */
@Singleton
public class DefaultRequestAccessEnforcer implements RequestAccessEnforcer {
  private final AuthenticationContext authenticationContext;
  private final AccessEnforcer accessEnforcer;

  @Inject
  public DefaultRequestAccessEnforcer(AuthenticationContext authenticationContext, AccessEnforcer accessEnforcer) {
