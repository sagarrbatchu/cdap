...
/**
 * Enforces authorization for the current request {@link Principal} to perform an
 * {@link Permission} on an {@link EntityId}.
 * @see AccessEnforcer for enforcer for any principal
 */
@Beta
public interface RequestAccessEnforcer {
